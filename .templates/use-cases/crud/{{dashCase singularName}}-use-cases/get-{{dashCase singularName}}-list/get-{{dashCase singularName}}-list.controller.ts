...
import { I{{pascalCase singularName}}Service } from "@infrastructure/database/{{dashCase singularName}}/i.{{dashCase singularName}}.service";
import { {{pascalCase singularName}}PagedModel } from "@infrastructure/database/{{dashCase singularName}}/{{dashCase singularName}}-paged-model";
